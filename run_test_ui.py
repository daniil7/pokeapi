...
def test_pokemons_list(browser):
    ...
    wait.until(
        EC.visibility_of_element_located(
            (By.CSS_SELECTOR, "#pokemons-list .pokemon-instance")))

    instances = browser.find_elements(By.CSS_SELECTOR,
                                      "#pokemons-list .pokemon-instance")
...
def test_pokemons_search(browser):
    ...
    instance = browser.find_element(
        By.CSS_SELECTOR, "#pokemons-list .pokemon-instance .pokemon-name")
...
def test_battle_round(browser):
    ...
    user_pokemon_hp = browser.find_element(By.CSS_SELECTOR,
                                           "#user-pokemon-hp").text
    enemy_pokemon_hp = browser.find_element(By.CSS_SELECTOR,
    ...
    wait.until(
        EC.visibility_of_element_located(
            (By.CSS_SELECTOR, ".user-choosing-number")))

    numbers_list = browser.find_elements(By.CSS_SELECTOR,
                                         ".user-choosing-number")
